...
import io.github.spencerau.cpsc298.generated.GeneratedItems;
import io.github.spencerau.cpsc298.generated.GeneratedBlocks;
import io.github.spencerau.cpsc298.generated.GeneratedCreativeTabs;
...
public class CPSC298Minecraft {
    ...
    // Creates a new food item with the id "cpsc298minecraft:example_id", nutrition 1 and saturation 2
    public static final DeferredItem<Item> EXAMPLE_ITEM = ITEMS.registerSimpleItem("example_item", new Item.Properties().food(new FoodProperties.Builder()
            .alwaysEdible().nutrition(1).saturationModifier(2f).build()));

    // Creates a creative tab with the id "cpsc298minecraft:example_tab" for the example item, that is placed after the combat tab
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.cpsc298minecraft")) //The language key for the title of your CreativeModeTab
    ...
    public CPSC298Minecraft(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Only attempt to register on the global NeoForge event bus if it succeeds; some
        // development environments can throw an IllegalArgumentException when registering
        // an instance that does not expose any @SubscribeEvent handlers. Guard and log
        // so startup continues without crashing.
        try {
            NeoForge.EVENT_BUS.register(this);
        } catch (IllegalArgumentException ex) {
            LOGGER.debug("Skipping global event-bus registration: {}", ex.getMessage());
        }
